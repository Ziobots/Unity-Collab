...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty cursorObj;
    ...
    protected virtual void OnEnable()
    {
        ...
        cursorObj = serializedObject.FindProperty("cursorObj");
    }
    ...
    protected virtual void DrawComponents()
    {
        ...
        EditorGUILayout.ObjectField(cursorObj, new GUIContent("cursorObj", "put cursor here."));
    }
}